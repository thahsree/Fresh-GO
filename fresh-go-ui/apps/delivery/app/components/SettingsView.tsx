...
export function SettingsView({
  ...
  return <>
    ...
    <section className="settings-section duty-status-section">
      <h2>Duty status</h2>
      <div className={`card setting-card duty-card ${isOnline ? "duty-online" : "duty-offline"}`}>
        <div className="duty-card-content">
          <div className="duty-info">
            ...
            <p>{isOnline ? "You are receiving orders and incoming requests." : "Toggle on to start receiving delivery requests."}</p>
          </div>
          <button
      ...
      <div className="card setting-card">
        ...
        <div className="setting-detail bordered">
          ...
          <div>
            ...
            <strong>{settings.preferredZone}</strong>
          </div>
